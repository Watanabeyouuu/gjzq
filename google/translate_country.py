...
@file: translate_country.py
@date: 2020/10/25 3:15 下午
...
for countries in country:
    # print(countries, country[countries])
    translator = Translator(to_lang="chinese")
    translation = translator.translate(countries)
    print(translation)
    country_name.append(countries)
    country_abbr.append(country[countries])
